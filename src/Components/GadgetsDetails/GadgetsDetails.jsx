            ...
            <div className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <button
                        ...
                        className="flex items-center gap-2 bg-sky-400 text-white font-medium py-2 px-6 rounded-full hover:bg-sky-700 transition"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 border border-sky-400 text-sky-300 py-2 px-6 rounded-full hover:bg-sky-800 transition"
                    >
